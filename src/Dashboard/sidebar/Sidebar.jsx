    ...
    <div className='flex flex-col w-56 border-r border-gray-300'>
      ...
      <div className='mt-8'>
       ...
       <div className='mt-[4rem]'>
        <div   className=' sm:w-[193px] w-[130px] cursor-pointer h-[41px] bg-[#FFA500] hover:bg-gray-100 rounded-[4px] p-2 mx-auto ' >
           <div className='flex md:gap-4 gap-2 justify-center items-center'>
           <i className="fa-solid fa-house text-[14px]"></i>
         <Link to="Main"><h5 className='md:text-[14px] text-[12px] font-[400] text-black'>Home</h5></Link>
           </div>
        </div>
        ...
        <div   className=' sm:w-[193px]  w-[130px] mx-auto cursor-pointer h-[41px] hover:bg-[#FFA500] bg-gray-100 rounded-[4px] p-2 mt-4'>
          ...
          <Link to="schoolinfo"> <h5 className='md:text-[14px] text-[12px] font-[400] text-black'>Students</h5></Link>
           </div>
        </div>
        <div className=' sm:w-[193px]  w-[130px] mx-auto cursor-pointer h-[41px] hover:bg-[#FFA500] bg-gray-100 rounded-[4px] p-2 mt-4'>
           <div className='flex gap-4 justify-center items-center'>
